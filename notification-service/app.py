...
def resolve_recipient(app_entry, recipient_type):
    """Resolve an email address from the app config using `{recipientType}Email`."""
...
def send_email_via_zoho(access_token, account_id, from_address, recipient_email, subject, html_body):
    """Send an email via the Zoho Mail API."""
...
def lambda_handler(event, context):
    ...
    try:
        ...
        recipient_email = resolve_recipient(app_entry, recipient_type)
        ...
        send_email_via_zoho(access_token, account_id, from_address, recipient_email, subject, html_body)
